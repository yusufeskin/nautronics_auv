...
class SetAttitudeHandler:
    """
    SET_ATTITUDE_TARGET ile hedef açı kontrolü.
    ALT_HOLD (depth hold) modunda çalışır — DVL gerektirmez.
    ...
    def set_target_attitude(self, roll, pitch, yaw):
        """
        Hedef orientation'ı ayarla (derece cinsinden).
        Throttle kontrolü depth_hold moduna bırakılır.
        """
