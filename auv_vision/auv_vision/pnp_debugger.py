...
class MultiObjectPnPNode(Node):
    ...
    def image_callback(self, msg):
        ...
        for box, kpts in zip(boxes, kpts_batch):
            ...
            cv2.putText(frame, obj_msg.class_name, (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
            ...
            for index in range(min(len(kpts), 4)):
                ...
                point = Point(x=x_val, y=y_val, z=0.0)
                ...
                cv2.putText(frame, str(index), (int(x_val)+5, int(y_val)-5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
            ...
            try:
                ...
                if success: 
                    ...
                    cv2.rectangle(frame, (text_x - 5, text_y_offset - text_h - 5), (text_x + text_w + 5, text_y_offset + 5), (0, 0, 0), -1)
                    cv2.putText(frame, info_text, (text_x, text_y_offset), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
